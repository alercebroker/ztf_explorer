                        ...
                        <b-card no-body class>
                            <ul v-if="$store.state.loading === false">
                                ...
                                <li v-if="ztf_object.classxmatch">
                                    <strong>Class:</strong>
                                    {{ getClass(ztf_object, "classxmatch") }} (X-MATCH)
                                </li>
                                <li v-if="ztf_object.classrf">
                                    <strong>Class:</strong>
                                    {{ getClass(ztf_object, "classrf") }} (ML_RF)
                                </li>
                                <li v-if="ztf_object.classrnn">
                                    <strong>Class:</strong>
                                    {{ getClass(ztf_object, "classrnn") }} (ML_RNN)
                                </li>
                                <li v-if="ztf_object.classrnn">
                                    <strong>Class:</strong>
                                    {{ getClass(ztf_object, "classrnn") }} (ML_RNN)
                                ...
                                <li>
                                    ...
                                    {{ ztf_object.meanra ? ztf_object.meanra.toFixed(4) : '-' }},{{ ztf_object.meandec ? ztf_object.meandec.toFixed(4) : '-' }}
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    {{ julianIntToDate(ztf_object.firstmjd) }}
                                </li>
                                <li>
                                    <strong>Last date:</strong>
                                    {{ julianIntToDate(ztf_object.lastmjd) }}
                                </li>
                            </ul>
                        </b-card>
                    </b-card-group>
