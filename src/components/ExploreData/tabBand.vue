<template>
    <div>
        <b-row class="align-middle">
            <b-col md="3" class="text-center small">min</b-col>
            <b-col md="4" class="text-center"> </b-col>
            <b-col md="3" class="text-center small">max</b-col>
        </b-row><hr>
        <b-row class="align-middle">
            <b-col md="3">
                <b-form-input id="minMinAny" size="sm" type="number" v-model="band.min.min" min="0" :max="band.min.max"></b-form-input>
            </b-col>
            <b-col md="4" class="text-center"> Min magnitude </b-col>
            <b-col md="3">
                <b-form-input id="maxMinAny" size="sm" type="number" v-model="band.min.max" :min="band.min.min"></b-form-input>
            </b-col>
            <b-col cols="2">
                <v-icon v-b-tooltip.hover.right title="Range of magnitudes for the dimmest alert of a source." name="info-circle" color="#C0C0C0"></v-icon>
            </b-col>
        </b-row>
        <br>
        <b-row class="align-middle">
            ...
            <b-col md="4" class="text-center"> Max magnitude </b-col>
            <b-col md="3">
                <b-form-input id="maxMaxAny" size="sm" type="number" v-model="band.max.max" :min="band.max.min"></b-form-input>
            </b-col>
            <b-col cols="2">
                <v-icon v-b-tooltip.hover.right title="Range of magnitudes for the brightest alert of a source." name="info-circle" color="#C0C0C0"></v-icon>
            </b-col>
        </b-row>
        <br>
        <b-row class="align-middle">
            ...
            <b-col cols="2">
                <v-icon v-b-tooltip.hover.right title="Range of allowed slopes between each consecutive pair of alerts of a source." name="info-circle" color="#C0C0C0"></v-icon>
            </b-col>
        </b-row>
        <br>
        <b-row class="align-middle">
            ...
            <b-col cols="2">
                <v-icon v-b-tooltip.hover.right title="Range of values for the mean magnitude of a source." name="info-circle" color="#C0C0C0"></v-icon>
            </b-col>
        </b-row>
        <br>
        ...
        <b-row class="align-middle">
            ...
            <b-col cols="2">
                <v-icon v-b-tooltip.hover.right title="Range of values for the magnitude of the latest alert of a source." name="info-circle" color="#C0C0C0"></v-icon>
            </b-col>
        </b-row>
