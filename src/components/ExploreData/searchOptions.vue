						...
						<b-card-body>
							...
							<b-row class="align-middle" name="ext">
								<b-col md="12" class="form-check">
									<b-form-group>
										<b-form-checkbox plain stacked id="ext">Has Crossmatch</b-form-checkbox>
									</b-form-group>
					...
					<b-collapse id="AdvancedSearch">
						...
						<b-container>
							<b-row class="text-center">
								<b-col>
									<b-btn variant="outline-secondary" v-b-toggle="'SQL'">
										Show SQL
									</b-btn>
								</b-col>
							</b-row>
							...
							<b-row>
								...
								<b-col class="text-center">
									<b-btn variant="warning" size="sm"> <!-- data-target="#subscribeModal" -->
										Subscribe
									</b-btn>
								</b-col>
							</b-row>
