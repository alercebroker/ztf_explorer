                        ...
                        <b-row class="mb-2">
                            <b-col class="align-middle">
                                <div class="text-center">
                                    <b-btn variant="outline-secondary" v-b-toggle="'AdvancedSearch'">More Options
                                    </b-btn>
                                </div>
                            </b-col>
                        </b-row>
                                    ...
                                    <div name="dates" class="mb-3">
                                        ...
                                        <b-card>
                                            ...
                                            <b-row class="align-middle" name="firstJD">
                                                <b-col>
                                                    <b-form-input size="sm" id="firstjd"
                                                                  v-model="queryParameters.dates.firstjd"></b-form-input>
                                                </b-col>
                                                <b-col>
                                                    <b-form-input
                                                            size="sm"
                                            ...
                                            <b-row class="align-middle" name="lastJD">
                                                <b-col>
                                                    <b-form-input size="sm" id="lastjd"
                                                                  v-model="queryParameters.dates.lastjd"></b-form-input>
                                                </b-col>
                                                <b-col>
                                                    <b-form-input
                                                            size="sm"
                                            ...
                                            <b-row class="align-middle">
                                                <b-col md="4">
                                                    <b-form-input size="sm" id="minjd"
                                                                  v-model="queryParameters.dates.deltajd.min"></b-form-input>
                                                </b-col>
                                                ...
                                                <b-col md="4">
                                                    <b-form-input size="sm" id="maxjd"
                                                                  v-model="queryParameters.dates.deltajd.max"></b-form-input>
                                                </b-col>
                                            </b-row>
                                        </b-card>
                                    </div>
                                                ...
                                                <b-tab title="List" disabled>
                                                    <b-container>
                                                        <b-row class="align-middle">
                                                            ...
                                                            <b-alert show class="small">.txt file, format:
                                                                "RA,DEC,RS\n"
                                                            </b-alert>
                                                        </b-row>
                                                    </b-container>
                                ...
                                <b-container>
                                    ...
                                    <b-row>
                                        <b-col class="text-center">
                                            <b-button variant="secondary" size="sm" id="savesearchbtn" disabled>Save
                                                search
                                            </b-button>
                                        </b-col>
                                        <b-col class="text-center">
