							...
							<b-card-body>
								<div>
									<b-row class="align-middle">
										...
										<b-col md="7">
											<input type="text" class="form-control disabled" id="oid" v-model="queryParameters.filters.oid" :disabled="loading">
										</b-col>
									</b-row>
								</div>
								<br>
										...
										<b-col md="6">
											<b-row>
												...
												<b-col md="8" class="text-left">
													<input class="form-control form-control-sm" id="minnobs" type="number" min="0" v-model="queryParameters.filters.nobs.min" :disabled="loading">
												</b-col>
											</b-row>
										</b-col>
										<b-col md="6">
											<b-row>
												...
												<b-col md="8" class="text-left">
													<input class="form-control form-control-sm" id="maxnobs" type="number" :min="queryParameters.filters.nobs.min " v-model="queryParameters.filters.nobs.max" :disabled="loading">
												</b-col>
											</b-row>
										</b-col>
									</b-row>
									...
									<b-row class="align-middle">
										...
										<b-col md="6">
											<b-row>
												...
												<b-col md="8" class="text-left">
													<input class="form-control form-control-sm" id="maxpclass" type="number" step="0.0001" :min="queryParameters.filters.pclass.min" max="1" v-model="queryParameters.filters.pclass.max" :disabled="loading">
												</b-col>
											</b-row>
										</b-col>
									</b-row>
